...
import { handler } from "sandbox-secret-rotator/secret-rotator-handler.js";

vi.mock("sandbox-commons/sdk-clients/index.js", () => {
...
const mockSecretsManager = vi.mocked(
  (
    await import("sandbox-commons/sdk-clients/index.js")
...
describe("secret-rotator-handler", () => {
  const secretArn =
    "arn:aws:secretsmanager:us-east-1:123456789012:secret:/Sandbox/myisb/Auth/JwtSecret-AAAAAA";
