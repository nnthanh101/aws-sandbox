...
import { GroupCostReportingLambdaEnvironmentSchema } from "sandbox-commons/lambda/environments/group-cost-reporting-lambda-environment.js";
...
beforeAll(async () => {
  ...
  vi.doMock("sandbox-commons/isb-services/index.js", () => ({
    IsbServices: {
  ...
  const module = await import(
    "sandbox-group-cost-reporting/group-cost-reporting-handler.js"
  );
