...
import { LeaseTemplateLambdaEnvironmentSchema } from "sandbox-commons/lambda/environments/lease-template-lambda-environment.js";
...
let handler: typeof import("sandbox-lease-templates/lease-templates-handler.js").handler;
...
beforeAll(async () => {
  ...
  handler = (
    await import(
      "sandbox-lease-templates/lease-templates-handler.js"
    )
  ).handler;
});
