...
import { AccountCleanupSuccessfulEvent } from "sandbox-commons/events/account-cleanup-successful-event.js";
...
} from "sandbox-commons/lambda/environments/account-lifecycle-management-lambda-environment.js";
...
import { AwsConsoleLink } from "sandbox-commons/utils/aws-console-links.js";
import {
...
async function handleAccountDrift(
  ...
  if (event.Detail.actualOu === undefined) {
    ...
    but has been removed from Sandbox completely`);
