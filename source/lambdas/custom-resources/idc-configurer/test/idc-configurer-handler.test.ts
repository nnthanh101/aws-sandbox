...
import { IdcConfigurerLambdaEnvironmentSchema } from "sandbox-commons/lambda/environments/idc-configurer-lambda-environment.js";
...
let handler: (typeof import("sandbox-idc-configurer/idc-configurer-handler.js"))["handler"];
...
beforeEach(async () => {
  handler = (
    await vi.importActual<
      typeof import("sandbox-idc-configurer/idc-configurer-handler.js")
    >("sandbox-idc-configurer/idc-configurer-handler.js")
  ).handler;
  vi.resetModules();
  bulkStubEnv(testEnv);
