...
import { AccountLifecycleManagementEnvironmentSchema } from "sandbox-commons/lambda/environments/account-lifecycle-management-lambda-environment.js";
import { sharedIdcSsmParamName } from "sandbox-commons/types/isb-types";
import { addAppConfigExtensionLayer } from "sandbox-infrastructure/components/config/app-config-lambda-extension";
import { EventsToSqsToLambda } from "sandbox-infrastructure/components/events-to-sqs-to-lambda";
...
import { AccountLifecycleManager } from "sandbox-lambda/account-lifecycle-management/account-lifecycle-manager.js";
