...
import { EmailNotificationEnvironmentSchema } from "sandbox-commons/lambda/environments/email-notification-lambda-environment.js";
...
vi.mock(
  "sandbox-commons/isb-services/notification/email-address-utils.js",
  async () => {
