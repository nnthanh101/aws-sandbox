...
import { CostExplorerService } from "sandbox-commons/isb-services/cost-explorer-service.js";
import { IdcService } from "sandbox-commons/isb-services/idc-service.js";
import {
  LogArchivingService,
  LogArchivingServiceProps,
} from "sandbox-commons/isb-services/log-archiving-service.js";
import {
  EmailService,
  EmailServiceProps,
} from "sandbox-commons/isb-services/notification/email-service.js";
...
export class IsbServices {
  ...
  public static isbEventBridge(
    ...
    return IsbClients.eventBridge(
      {
        eventSource: `Sandbox-${env.ISB_NAMESPACE}`,
      },
      env,
    );
  }
