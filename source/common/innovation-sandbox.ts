...
import { PutResult } from "sandbox-commons/data/common-types.js";
...
import {
  LeaseFrozenEvent,
  LeaseFrozenReason,
} from "sandbox-commons/events/lease-frozen-event.js";
...
} from "sandbox-commons/events/lease-terminated-event.js";
...
} from "sandbox-commons/sdk-clients/event-bridge-client.js";
...
import {
  ...
  parseDatetime,
} from "sandbox-commons/utils/time-utils.js";
import { Transaction } from "sandbox-commons/utils/transactions.js";
import { Tracer } from "@aws-lambda-powertools/tracer";
import { randomUUID } from "crypto";

export class SandboxError extends Error {}
export class NoAccountsAvailableError extends SandboxError {}
export class MaxNumberOfLeasesExceededError extends SandboxError {}
export class AccountNotInQuarantineError extends SandboxError {}
export class AccountInCleanUpError extends SandboxError {}
export class AccountNotInActiveError extends SandboxError {}
export class AccountNotInFrozenError extends SandboxError {}
export class CouldNotFindAccountError extends SandboxError {}
export class CouldNotRetrieveUserError extends SandboxError {}
...
export class Sandbox {
  ...
  public static async approveLease(
    ...
    const [freeAccount, leaseUser] = await Promise.all([
      Sandbox.acquireAvailableAccount(context),
  ...
  public static async ejectAccount(
    ...
    await Sandbox.terminateLeasesAssociatedWithAccount(context, {
